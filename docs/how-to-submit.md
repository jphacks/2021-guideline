...
- JPHACKSではGitHubを活用した製品開発を推奨し、GitHubを活用した製品情報の提出がオンライン一次審査では必須となっておりますので、以下の流れに従ってソース・コードを正しく提出されることを強く推奨します。詳細は[審査方法](how-to-judge.md)を御覧ください。  
...
* [プロダクト提出フォーム](https://goo.gl/forms/yG3tLGCZxv9Oms2t1)にアクセスし、必要事項を記入します。
